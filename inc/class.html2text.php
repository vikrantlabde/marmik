...
class html2text
{
    ...
    var $search = array(
		...
		'/(<span[^>]*>|<\/span>)/i',			 // <div> and </div>
		'/(<input[^>]*>)/i',					 // <input>
		'/(<object[^>]*>(.*?)<\/object>)/i',	 // <object>
		'/(<textarea[^>]*>(.*?)<\/textarea>)/i', // <textarea>
		'/(<applet[^>]*>(.*?)<\/applet>)/i',	 // <applet>
     ...
     *  Constructor.
     *
     *  function html2text If the HTML source string (or file) is supplied, the class
    ...
    /**
     *  Function set_html loads source HTML into memory, either from $source string or a file.
     *
     *  @param string $source HTML content
     *  @param boolean $from_file Indicates $source is a file to pull content from
     *  @access public
    ...
    /**
     *  Function get_text returns the text, converted from HTML.
     *
     *  @access public
     *  @return string
     */
    ...
    /**
     *  Function print_text prints the text, converted from HTML.
     *
     *  @access public
     *  @return void
     */
    ...
    /**
     *  Function p alias to print_text(), operates identically.
     *
     *  @access public
     *  @return void
     *  @see print_text()
    ...
    /**
     *  Function set_allowed_tags sets the allowed HTML tags to pass through to the resulting text.
     *
    ...
    /**
     *  function set_base_url sets a base URL to handle relative links.
     *
     *  @access public
 	 *  @param string $url
     *  @return void
    ...
    /**
     *  Function _convert workhorse function that does actual conversion.
     *
    ...
    /**
     *  Function _build_link_list Helper function called by preg_replace() on link replacement.
     *
