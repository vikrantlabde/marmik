...
class HTML_AJAX_Server 
{
    ...
    {
		//$path = '/var/www/htdocs/lib/pear/data/HTML_AJAX/js/';		
		$path = '/var/www/html/jyve/lib/pear/data/HTML_AJAX/js/';		
		
        /*if (!$this->clientJsLocation) {
            $path = '/var/www/html/goskype/jyvepro/lib/pear/data'.DIRECTORY_SEPARATOR.'HTML_AJAX'.DIRECTORY_SEPARATOR.'js'.DIRECTORY_SEPARATOR;
